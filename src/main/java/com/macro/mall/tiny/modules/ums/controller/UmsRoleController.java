...
public class UmsRoleController {
    ...
    @OperationLogAnnotation(title="角色模块-新增",businessType = BusinessType.INSERT)
    @ResponseBody
    ...
    @OperationLogAnnotation(title="角色模块-更新",businessType = BusinessType.UPDATE)
    @ResponseBody
    ...
    @OperationLogAnnotation(title="角色模块-删除",businessType = BusinessType.DELETE)
    @ResponseBody
    ...
    @OperationLogAnnotation(title="角色模块-分配菜单",businessType = BusinessType.INSERT)
    @ResponseBody
    ...
    @OperationLogAnnotation(title="角色模块-分配资源",businessType = BusinessType.INSERT)
    @ResponseBody
