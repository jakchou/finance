...
import com.macro.mall.tiny.modules.ums.dto.UmsResourceVo;
  ...
  /*  @Operation(summary = "修改后台资源")
   ...
   /* @Operation(summary = "分页模糊查询后台资源")
    ...
    public CommonResult<List<UmsResourceVo>> listAll() {
        ...
        List<UmsResourceVo> list = OrikaMapper.mapList(resourceList,UmsResourceDto.class,UmsResourceVo.class);
