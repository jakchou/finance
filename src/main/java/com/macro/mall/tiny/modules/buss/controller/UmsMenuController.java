...
public class UmsMenuController {
 ...
 /*   @RequestMapping(value = "/create", method = RequestMethod.POST)
    @ResponseBody
    @OperationLogAnnotation(title="菜单模块-新增",businessType = BusinessType.INSERT)
    ...
    @OperationLogAnnotation(title="菜单模块-更新",businessType = BusinessType.UPDATE)
    @ResponseBody
  ...
  /* @Operation(summary = "根据ID获取菜单详情")
    ...
    @OperationLogAnnotation(title="菜单模块-查询",businessType = BusinessType.DELETE)
    @ResponseBody
  ...
  /*  @Operation(summary = "根据ID删除后台菜单")
    ...
    @OperationLogAnnotation(title="菜单模块-删除",businessType = BusinessType.DELETE)
    @ResponseBody
