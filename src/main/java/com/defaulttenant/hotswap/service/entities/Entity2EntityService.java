package com.defaulttenant.hotswap.service.entities;
...
import com.defaulttenant.hotswap.domain.structure.*;
import com.defaulttenant.hotswap.repository.entities.Entity2EntityMapper;
import com.defaulttenant.hotswap.util.SnowflakeIdWorker;
import com.defaulttenant.hotswap.util.CommonFunctionUtil;
import com.defaulttenant.hotswap.service.entities.AbstractService;
import com.defaulttenant.hotswap.service.entities.inner.RelationInnerService;
import com.defaulttenant.hotswap.service.dto.filters.*;
import com.defaulttenant.hotswap.service.dto.filters.atomic.*;
import com.defaulttenant.hotswap.service.dto.filters.logic.unary.*;
import com.defaulttenant.hotswap.service.dto.filters.logic.binary.matching.*;
import com.defaulttenant.hotswap.util.ExcelUtil;
import com.defaulttenant.hotswap.context.UserContext;
/**
* auto generate Entity2EntityService ServiceImpl
*
* @author sys
*/
@Service
public class Entity2EntityService extends AbstractService {
    @Resource
    private Entity2EntityMapper mapper;
    @Resource
    ...
    **/
    ...
    public Entity2Entity create(Entity2Entity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<Entity2Entity> batchCreate(List<Entity2Entity> entities) {
        ...
        // fill default value
        List<Entity2Entity> batchList = new ArrayList<>(100);
        for (Entity2Entity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
    ...
    **/
    @Transactional
    public Entity2Entity update(Entity2Entity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "Entity2Entity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<Entity2Entity> batchUpdate(List<Entity2Entity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<Entity2Entity> updateEntities = new ArrayList<>(entities.size());
        for (Entity2Entity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        Entity2Entity entity = mapper.selectOne( id ); 
    ...
    **/
     ...
     * auto gen get method
     **/
    public Entity2Entity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<Entity2Entity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<Entity2Entity> data = ExcelUtil.read(file.getInputStream(), type, Entity2Entity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<Entity2Entity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, Entity2Entity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + Entity2Entity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public Entity2Entity createOrUpdate(Entity2Entity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, Entity2Entity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            Entity2Entity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(Entity2Entity entity, List<String> updateFields, AbstractQueryFilter filter) {
