...
public class AppSendNewsMessageBodyStructure {
    ...
    public Long agentid;
    public com.defaulttenant.hotswap.domain.structure.connector.qiweionlineconnector.News1Structure news;
    ...
    public com.defaulttenant.hotswap.domain.structure.connector.qiweionlineconnector.News1Structure getNews() {
        return news;
    } 

    public void setNews(com.defaulttenant.hotswap.domain.structure.connector.qiweionlineconnector.News1Structure news) {
        this.news = news; 
    } 
